...
# ==================== WELCOME PROMPT (missing fix) ====================
# Provides _ensure_welcome_prompt and WelcomeRootView used by /setup-welcome and /welcome-post.
class WelcomeRootView(discord.ui.View):
    ...
    async def start_roster(self, interaction: discord.Interaction, button: discord.ui.Button):
        # Prefer existing RosterStartView if present
...
# Backwards-compat name expected by some builds
_ensure_welcome_prompt = ensure_welcome_prompt
# ==================== END WELCOME PROMPT (missing fix) ====================
